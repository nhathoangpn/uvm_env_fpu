class fpu_test_flog_cnt_pointer_cov_improve extends fpu_test_base;
	`uvm_component_utils(fpu_test_flog_cnt_pointer_cov_improve)
	...
	task run_phase(uvm_phase phase);
		...
		if (!seq_sdirect.randomize() with
			{sub_num_seq_item == 1;
			 sqb_valid_i == 1;
			 sqb_op_i == `FLOG;
			 sqb_operand_a_i == 32'h3f7f_fff7;
			 sqb_operand_b_i == 32'hb54f_bf86;
